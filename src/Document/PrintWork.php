...
// deferred — see plan notes. session/paperBrand/contactSheetRef/
...
class PrintWork
{
    ...
    #[ODM\Field(nullable: true, enumType: PaperBrand::class)]
    #[
        Groups([
            SerializationGroups::PRINT_READ_GROUP,
            SerializationGroups::PRINT_WRITE_GROUP,
    ...
    public ?PaperBrand $paperBrand = null;
    ...
    public ?string $paperBrandOther = null;
    ...
    public ?string $paperModel = null;

    #[ODM\Field(nullable: true, enumType: PaperBase::class)]
    #[
        Groups([
            SerializationGroups::PRINT_READ_GROUP,
            SerializationGroups::PRINT_WRITE_GROUP,
    ...
    public ?PaperBase $paperBase = null;

    #[ODM\Field(nullable: true, enumType: PaperSurface::class)]
    #[
        Groups([
            SerializationGroups::PRINT_READ_GROUP,
            SerializationGroups::PRINT_WRITE_GROUP,
    ...
    public ?PaperSurface $paperSurface = null;
    ...
    public function getPaperBrand(): ?PaperBrand
    {
        return $this->paperBrand;
    }

    public function setPaperBrand(?PaperBrand $paperBrand): static
    {
        $this->paperBrand = $paperBrand;
        return $this;
    }

    public function getPaperBrandOther(): ?string
    {
        return $this->paperBrandOther;
    }

    public function setPaperBrandOther(?string $paperBrandOther): static
    {
        $this->paperBrandOther = $paperBrandOther;
        return $this;
    }

    public function getPaperModel(): ?string
    {
        return $this->paperModel;
    }

    public function setPaperModel(?string $paperModel): static
    {
